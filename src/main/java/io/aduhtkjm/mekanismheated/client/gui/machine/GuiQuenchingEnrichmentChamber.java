...
public class GuiQuenchingEnrichmentChamber extends GuiConfigurableTile<TileEntityQuenchingEnrichmentChamber, MekanismTileContainer<TileEntityQuenchingEnrichmentChamber>> {
    ...
    public GuiQuenchingEnrichmentChamber(MekanismTileContainer<TileEntityQuenchingEnrichmentChamber> container, Inventory inv, Component title) {
        ...
        dynamicSlots = true;
        //The player inventory slots are shifted down by 5 by the container (see ModContainerTypes.QUENCHING_ENRICHMENT_CHAMBER),
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiProgress(tile::getScaledProgress, ProgressType.BAR, this, 86, 43).recipeViewerCategory(tile))
            .warning(WarningType.INPUT_DOESNT_PRODUCE_OUTPUT, tile.getWarningCheck(RecipeError.INPUT_DOESNT_PRODUCE_OUTPUT));
        addRenderableWidget(new GuiFluidGauge(() -> tile.inputFluidTank, () -> tile.getFluidTanks(null), GaugeType.STANDARD.with(DataType.INPUT), this, 26, 15))
        ...
        addRenderableWidget(new GuiFluidGauge(() -> tile.outputFluidTank, () -> tile.getFluidTanks(null), GaugeType.STANDARD.with(DataType.OUTPUT), this, 115, 15))
